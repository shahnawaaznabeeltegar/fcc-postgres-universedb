...
CREATE TABLE public.moon (
    ...
    nmae_code character varying(255) NOT NULL
);
...
INSERT INTO public.star VALUES (3, 123461234, 'yellow', 'ajo', 1);
...
--
-- Name: moon moon_nmae_code_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.moon
    ADD CONSTRAINT moon_nmae_code_key UNIQUE (nmae_code);
